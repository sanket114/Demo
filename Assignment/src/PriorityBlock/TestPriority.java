...
public class TestPriority {
		...
		public static void main(String[] args) {
			BlockingQueue<Student> lstudent=new PriorityBlockingQueue<Student>(5);
			BlockingQueue<Student> lstudentempty=new PriorityBlockingQueue<Student>(3);
